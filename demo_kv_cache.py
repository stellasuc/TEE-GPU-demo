"""Demo for the dynamic masked K cache."""
...
def main() -> None:
    ...
    while remaining > 0:
        ...
        cache.append(torch.randn(size, args.dim, device=trusted_device, dtype=trusted_dtype))
        remaining -= size
    ...
    print(f"key_rank={args.key_rank} query_rank={args.query_rank}")
